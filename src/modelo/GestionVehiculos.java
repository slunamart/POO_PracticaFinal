...
public class GestionVehiculos implements Gestionable{
    ...
    public void alta(){
        ...
        System.out.println("========================================================");
        System.out.println("Elige la sección en el que irá el vehículo");
        ...
        vehiculo.setAnioFabric( Integer.toString( MyInput.readInt("Año de fabricación") ) ) ;
        vehiculo.setPrecioBase( BigDecimal.valueOf( MyInput.readDouble("Precio base") ) );
        do{
            vehiculo.setStock( MyInput.readInt("Stock") );
            if(vehiculo.getStock()< 1){
                System.out.println("ERROR: El stock de un vehículo nuevo debe ser superior o igual a 1.");
            }
        }while(vehiculo.getStock() < 1);
        vehiculo.setID();
        System.out.println("Nuevo vehiculo dado de alta, código: "+ vehiculo.getID());
        System.out.println("========================================================");
    ...
    public void baja(){
        ...
        String IDbuscar = MyInput.readString("Introduce el ID del vehiculo");
        Vehiculo vehiculo = c.buscarPorID(IDbuscar);
        int qtty = MyInput.readInt("Cuántos vehículos quieres dar de baja");
        vehiculo.setStock(vehiculo.getStock()-qtty);
    }
